class FareAlgorithm < BiizAction::Base
  ...
  total_fare = base_fare + (base_fare * car_weight_factor) + (base_fare * time_factor) + (base_fare * battery_factor) + (base_fare * availability_factor) + (base_fare * distance_factor) + (base_fare * arrival_time_factor)
